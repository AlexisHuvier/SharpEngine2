...
namespace SE2.Graphics.Renderers
{
    class SpriteSheetRenderer
    {
        ...
        public static void Render(Window win, string shader, string texture, int frameIndex, Utils.Vec2 spriteSize, bool flipX, bool flipY, float alpha, Matrix4 model)
        {
